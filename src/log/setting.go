...
func InitLog() error {
	...
	f1, err1 = os.OpenFile(path+"TraceLog.log", os.O_CREATE|os.O_WRONLY|os.O_APPEND, 0666)
	if err1 != nil{
		return err1  //TraceLog文件打开失败
	}
	f2, err2 = os.OpenFile(path+"errorsLog.log", os.O_CREATE|os.O_WRONLY|os.O_APPEND, 0666)
	if err2 != nil{
